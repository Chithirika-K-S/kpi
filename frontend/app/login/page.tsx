  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const dest =
        ...
        data.user.role === 'Manager'     ? '/dashboard/manager' :
        data.user.role === 'Team Lead'   ? '/dashboard/lead'    :
                                           '/dashboard/member';
      router.push(dest);
    } catch {
        ...
        <div className="px-8 py-9">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Secure team access</p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 text-sm text-slate-900 bg-white border border-slate-300 rounded-lg placeholder-slate-400
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-9 pr-10 py-2.5 text-sm text-slate-900 bg-white border border-slate-300 rounded-lg placeholder-slate-400
                             focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                />
                <button
                  type="button"
